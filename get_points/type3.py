...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 19 16:56:15 2019
...
import cv2
def getpoint(image):
    #image = cv2.imread('odf_test/type3_1.jpg')
    ...
    #cv2.imwrite("type/type3_1.jpg",np.hstack([Img, BlueThings]))
    ...
    if vis==True:
        ...
        #cv2.imwrite("result/type3_1.jpg",image)
